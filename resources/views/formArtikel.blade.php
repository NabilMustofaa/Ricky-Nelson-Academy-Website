...
<div class="container-fluid d-flex flex-column mside">
    ...
    <form method="post" action="/dashboard/artikel" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('judul_artikel') is-invalid @enderror"  id="judul_artikel" name="judul_artikel" placeholder="" value="{{ old('judul_artikel') }}">
            @error('judul_artikel')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="" value="{{ old('slug') }}">
            @error('slug')
            <div class="invalid-feedback">
               {{$message}}
            </div>
        ...
        <div class="mb-3">
            ...
            @enderror
            <input id="isi_artikel" type="hidden" name="isi_artikel" value="{{ old('isi_artikel') }}">
